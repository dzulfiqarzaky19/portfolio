  ...
  return (
    <section className="py-20 bg-[hsl(var(--primary))] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
         <h2 className="text-3xl font-bold font-display mb-4">Business Impact</h2>
         <p className="text-white/80 max-w-2xl mx-auto mb-16">Measuring success through performance, accessibility, and quality.</p>
         
         <div className="grid md:grid-cols-3 gap-8">
             {data.businessImpact.map((item, index) => (
                 <div key={index} className="group relative overflow-hidden rounded-2xl bg-black/20 border border-white/10 hover:border-white/30 transition-all text-left">
