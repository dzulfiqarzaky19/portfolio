...
import { BarChart, Globe, Handshake, LayoutDashboard, ShieldCheck, TrendingUp } from 'lucide-react';
    ...
    technicalContributions: [
        {
            ...
            description: 'Built customized canvas-based charts for transaction dashboards (finance formatting, tooltips, legends).',
            icon: BarChart
        },
        {
            title: 'Ops Dashboards',
            description: 'Integrated maps and composed Ant Design dashboards for internal operations teams.',
            icon: LayoutDashboard
        },
        {
            title: 'API Alignment',
            description: 'Partnered with backend engineers to define and consume APIs without reliable Swagger, aligning contracts via test payloads.',
            icon: Handshake
        }
    ],
    businessImpact: [
        {
            ...
            metric: 'Internal Ops',
            description: 'Delivered reliable dashboards for internal ops teams, improving transaction visibility.',
            image: '/images/experience/mandiri/ops.png'
        },
        {
            title: 'Data Visualization',
            metric: 'Custom Charts',
            description: 'Enhanced data visualization with custom charts tailored to financial reporting needs.',
            image: '/images/experience/mandiri/charts.png'
        },
        {
            title: 'Team Collaboration',
            metric: 'Access & Contracts',
            description: 'Strengthened collaboration between frontend and backend teams in a complex enterprise environment.',
    ...
    keyTakeaways: [
        {
            ...
            description: 'Gained insight into strict security and data handling requirements in banking.',
            icon: ShieldCheck
        },
        {
            title: 'Custom Viz',
            description: 'Advanced skills in creating bespoke data visualizations beyond standard libraries.',
            icon: TrendingUp
        },
        {
            title: 'Cross-functional',
            description: 'Learned to navigate and align with diverse teams in a large corporate structure.',
            icon: Globe
        }
    ],
    theme: {
