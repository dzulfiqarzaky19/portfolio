...
export const TRELLO_CLONE_PROJECT: ProjectData = {
    ...
    sections: [
        ...
        },
        {
            ...
            description: "Modern full-stack TypeScript stack with carefully chosen technologies optimized for type safety, developer experience, and production performance.",
            isTilted: true,
...
- Vitest > Jest: 10x faster test execution`,
                ...
                bullets: [
                    {
                        ...
                        message: "Edge-optimized and lighter weight with faster runtime performance. Less magic means easier debugging."
                    },
                    {
                        title: "Supabase over Firebase",
                        message: "Open-source with PostgreSQL backing provides superior query flexibility compared to NoSQL constraints. Migration path via PostgreSQL export."
                    },
                    {
                        title: "Radix UI Primitives",
                        message: "Unstyled, WAI-ARIA compliant components provide accessibility out-of-the-box with 100% styling control."
                    },
                    {
                        title: "Feature-Based Architecture",
                        message: "Each feature module contains API routes, components, hooks, and schemas co-located for better maintainability and team parallelization."
                    }
                ]
            }
        },
        {
            ...
            description: "Feature-based modular organization with clear separation between client routes, API layer, and shared utilities.",
            isTilted: false,
...
└── lib/                    # Shared utilities
    ...
    └── session-middleware.ts`,
                ...
                bullets: [
                    {
                        ...
                        message: "All code for a feature lives together (API, UI, types, tests) making changes localized and refactoring safer."
                    },
                    {
                        title: "Team Parallelization",
                        message: "Multiple developers can work on different features simultaneously without merge conflicts."
                    },
                    {
                        title: "Clear Boundaries",
                        message: "Each feature owns its domain logic, preventing tight coupling and making features easy to add or remove."
                    }
                ]
            }
        },
        {
            ...
            description: "Separation of concerns via service layer with type-safe Result pattern for explicit error handling without try-catch overhead.",
            isTilted: true,
  ...
  return c.json({ data: result.data });
            ...
            content: {
                bullets: [
                    {
                        title: "Testability",
                        message: "Services can be unit tested independently without spinning up HTTP server or database."
                    },
                    {
                        title: "Reusability",
                        message: "Business logic is decoupled from HTTP transport, making it reusable across different routes."
                    },
                    {
                        title: "Type-Safe Errors",
                        message: "Result type forces explicit error handling with discriminated unions - no hidden exceptions."
                    }
                ]
            }
        },
  ...
  onSettled: () => {
    queryClient.invalidateQueries({ queryKey: ['tasks', projectId] });
        ...
        },
        {
            ...
            description: "Comprehensive testing approach using Vitest with focus on service layer, component logic, and schema validation for 80% coverage target.",
            isTilted: true,
                ...
                bullets: [
                    {
                        ...
                        message: "Vite-native test runner with 10x faster execution. jsdom environment for component testing."
                    },
                    {
                        title: "Test Pyramid Approach",
                        message: "Unit tests (Hooks, Schemas, Utils) → Integration tests (API routes, Services) → E2E (manual browser testing)."
                    },
                    {
                        title: "80% Coverage Target",
                        message: "Focus on service layer and business logic. Testing Library for component tests encourages accessibility-focused testing."
                    }
                ]
            }
        },
